...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'chat-widget-disclaimer': "You're chatting with an AI assistant, not municipal staff — answers may not always be complete or accurate. Nothing you type is saved; this conversation clears when you close the chat. For official transactions, confirm with the municipal office directly.",
  ...
  fil: {
    ...
    'chat-widget-disclaimer': 'Nakikipag-usap ka sa isang AI assistant, hindi sa staff ng munisipyo — maaaring hindi laging kumpleto o tumpak ang mga sagot. Walang ise-save sa anumang ise-type mo; nawawala ang usapang ito kapag isinara ang chat. Para sa opisyal na transaksyon, kumpirmahin nang direkta sa tanggapan ng munisipyo.',
