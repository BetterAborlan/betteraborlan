      ...
      {showInstall && (
        <div className="pwa-install-banner" role="alert" aria-live="polite">
          <div className="pwa-install-content">
            ...
            <span>Install BetterAborlan for quick access to services.</span>
          </div>
          <div className="pwa-install-actions">
            <button className="pwa-install-btn" onClick={handleInstall} aria-label="Install BetterAborlan app">
              Install
            </button>
            <button
