 ...
 *
 * Fetches the latest posts from the official Municipality of Aborlan Palawan
 * Facebook Page via the Graph API, derives a title/summary, categorizes each
 * post, validates it, and merges the result into data/news.json alongside any
 * manually-curated entries. The homepage's FbFeed component renders the
